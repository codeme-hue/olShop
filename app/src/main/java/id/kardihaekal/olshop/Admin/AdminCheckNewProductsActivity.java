...
public class AdminCheckNewProductsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    unverifiedProductsRef = FirebaseDatabase.getInstance()
    ...
    FirebaseRecyclerOptions<Products> options =
        new FirebaseRecyclerOptions.Builder<Products>()
            .setQuery(unverifiedProductsRef.
                    orderByChild("productState").equalTo("Not Approved")
          ...
          protected void onBindViewHolder(@NonNull
            ...
            holder.itemView.setOnClickListener(new OnClickListener() {
              ...
              public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new Builder(AdminCheckNewProductsActivity.this);
                builder.setTitle("Apakah anda ingin menyetujui produk ini. Yakin?");
    ...
    unverifiedProductsRef.child(productID)
      ...
      public void onComplete(@NonNull Task<Void> task) {
        ...
        Toast.makeText(AdminCheckNewProductsActivity.this,
            "Barang tersebut telah disetujui, dan sekarang tersedia untuk dijual dari penjual.",
